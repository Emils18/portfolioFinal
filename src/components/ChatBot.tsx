  ...
  return (
    <>
      ...
      <motion.button
        ...
        whileTap={{ scale: 0.95 }}
        className="fixed bottom-6 right-6 z-50 flex h-14 w-14 items-center justify-center rounded-full bg-gradient-to-br from-indigo-500 to-purple-600 shadow-[0_0_30px_rgba(99,102,241,0.5)]"
      >
        <motion.div
        ...
        {isOpen && (
          ...
          >
            ...
            <div className="h-64 overflow-y-auto p-4 space-y-3 text-sm">
              ...
              {/* Suggestions after AI reply (not while loading) */}
